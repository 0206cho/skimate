package org.all4.skimate.jwt.filter;
...
public class JwtAuthenticationProcessingFilter extends OncePerRequestFilter {
    ...
    public void checkRefreshTokenAndReIssueAccessToken(HttpServletResponse response, String refreshToken) {
        memberRepository.findByRefreshToken(refreshToken)
                .ifPresent(member -> {
                    ...
                    jwtService.sendAccessTokenAndRefreshToken(response, jwtService.createAccessToken(member.getMemberId()),
    ...
    public void checkAccessTokenAndAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        jwtService.extractAccessToken(request)
                        .filter(jwtService::isTokenValid)
                                .ifPresent(accessToken-> jwtService.extractMemberId(accessToken) //여기서 왜 안넘어갈까....
    ...
    public void saveAuthentication(Member myUser) {
        ...
        String password = myUser.getMemberPw();
